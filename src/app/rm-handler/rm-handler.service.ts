...
export class RmHandlerService {
  ...
  getCharacters(){
    return this.http.get(this.charactersEndPoint);
  }

  getCharactersById(id){
    return this.http.get(`${this.charactersEndPoint}${id}`);
  }

  getLocations(){
    return this.http.get(this.locationsEndPoint);
  }
  ...
  getEpisodes(){
    return this.http.get(this.episodesEndPoint);
  }

  getEpisodesById(id){
    return this.http.get(`${this.episodesEndPoint}${id}`);
  }
